         ...
         {showajouter ? (
          <><div>
                                        ...
                                        <div className="mt-[4%] ml-[34%]">
                                            ...
                                            <button className="bg-[#54C757] hover:bg-[#50BE54] text-white font-bold py-3 px-14 rounded-xl mt-[%]">
                                                Ajouter
                                            </button>
                                        </div></>
         ) : null}
...
{!showajouter ? (
  ...
  <div>
    ...
    <div className="mt-[-23%] ml-[10%]">
      <button className="bg-[#54C757] hover:bg-[#50BE54] text-white font-bold py-3 px-14 rounded-xl mt-[6%]">
        Supprimer
      </button>
    </div>
  </div>
