...
<div className="grid grid-cols-6 bg-mypurple mt-[1,1%] ">
                ...
                <div className=" bg-mypurple h-screen col-span-5  mt-[1,1%] ">
                    ...
                    <div className="flex ml-[3.2%] mt-[2%]">
                        <p
                        className={`text-sm w-1/5 cursor-pointer ${
                            selectedParagraph === "ajouterClub"
                            ? "text-black font-bold"
                            : "text-gray-500 cursor-pointer"
                        }`}
                        onClick={() => handleParagraphClick("ajouterClub")}
                        >
                        ajouter un club
                        </p>
                        <p
                        className={`text-sm w-[22%] cursor-pointer ${
                            selectedParagraph === "supprimerClub"
                            ? "text-black font-bold"
                            : "text-gray-500 cursor-pointer"
                        }`}
                        onClick={() => handleParagraphClick("supprimerClub")}
                        >
                        Supprimer un club
                        </p>
                        <p
                        className={`text-sm w-1/4 cursor-pointer ${
                            selectedParagraph === "ajouterEvenement"
                            ? "text-black font-bold"
                            : "text-gray-500 cursor-pointer"
                        }`}
                        onClick={() => handleParagraphClick("ajouterEvenement")}
                        >
                        ajouter un évenement
                        </p>
                        <p
                        className={`text-sm w-[30%] cursor-pointer ${
                            selectedParagraph === "supprimerEvenement"
                            ? "text-black font-bold"
                            : "text-gray-500 cursor-pointer"
                        }`}
                        onClick={() => handleParagraphClick("supprimerEvenement")}
                        >
                        ...
                        <div
                        className={`${
                            selectedParagraph === "ajouterClub" ? "" : "hidden"
                        }`}
                        >
    ...
    <div>
                ...
                <div className="mt-4">
                    ...
                    />
                        ...
                        <div
                        className={`${
                            selectedParagraph === "supprimerClub" ? "" : "hidden"
                        }`}
                        >
{/* Contenu pour supprimer un club */}
                        ...
                        <div
                        className={`${
                            selectedParagraph === "ajouterEvenement" ? "" : "hidden"
                        }`}
                        >
{/* Contenu pour ajouter un événement */}
                <div className="flex flex-col items-center justify-center mt-[3%] ">
                    ...
                    <div
                        className={`${
                            selectedParagraph === "supprimerEvenement" ? "" : "hidden"
                        }`}
                        >
