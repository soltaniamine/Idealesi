        ...
        <div className="recent w-[96,5%] h-[90%]">
            <div className='flex justify-between items-end'>
                <div className="posss flex mb-4 w-96 ml-8">
                    ...
                    <img className="line2 w-36" src={require("../../../assets/Acceuil/Home/Rectangle 4271.svg").default} alt="" />
                    <img className="sousligne2 w-24" src={require("../../../assets/Acceuil/Home/Group.svg").default} alt="" />
                </div>
                <div>
