    ...
    useEffect(() => {
        if (project && project.length > 0) {
            setItems(project.map((prj) => (
                prj.favori == 1 ? <div key={prj.projet_id} className="mt-6 ml-6 w-36 h-44">
    ...
    useEffect(() => {
        if (project && project.length > 0) {
            setItem(project.map((pr) => (
                pr.favori == 1 ? <div className='grid grid-cols-3 space-x-24 h-[40%] border-b-2 border-gray-300 mt-3'>
        ...
        <div className="recent w-[96,5%] h-[90%]">
            <div className='flex justify-between items-end'>
                <div className="posss flex mb-4 w-96 ml-8">
                    <h1 className="z-10 text-2xl mt-7 ml-5">Projets préférés</h1>
                ...
                <div>
                    <div className='flex justify-between items-center w-44 mb-4 mr-10'>
                        <button onClick={() => handleNewProjectClick()} className='text-xs bg-mypurple text-white px-3 py-1.5 rounded-lg'>Nouveau projet +</button>
                    ...
                    <div className='flex justify-center'>
                        <div className='w-[93%] mt-10'>
                            <div className='grid grid-cols-3 space-x-24 h-[40%] border-b-2 border-gray-300 font-bold '>
                                ...
                                <p className='mr-10'>Date de Creation </p>
                            </div>
                            {item}
                        </div>
                    </div>
