...
const Sidebar = ({ buttonColor }) => {
    ...
    useEffect(() => {
        const fetchType = async () => {
            try {
                const response = await axios.post('http://127.0.0.1:5000/type', { user_id: uid });
    ...
    return ( 
        <div className="sidebar h-screen flex flex-col">
            ...
            <div className="flex flex-col items-end space-y-4 text-black text-sm">
                ...
                >
                    <Link className="flex" to={`/home?uid=${uid}`}>
                ...
                {userType === 'Utilisateur' &&
                    ...
                    >
                        <Link className="flex" to={`/admine?uid=${uid}`}>
                ...
                {userType === 'Prof' &&
                    ...
                    >
                        <Link className="flex" to={`/prof?uid=${uid}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
