...
const I_cp = () => {
   ...
   useEffect(() => {
     const filteredModules = modules.filter(module => module.niveau_id === 1);
   ...
   return (
     <div>
       ...
       <div className="mr-[3%] ml-[4%]  mb-[5%] rounded-lg  border-dashed  border-black border-4 relative">
         <div>
           <h1 className="  z-10 text-2xl  font-bold ml-[48%] absolute mt-[0.3%]  ">1 CP</h1>
...
//    const niveauModule = async () => {
//       try {
//         const response = await axios.get('http://127.0.0.1:5000/liste_module', { params: { Module_ID, Nom_module, Niveau_ID, Nom_niveau } });
