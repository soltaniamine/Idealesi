...
const Twocssid = () => {
   ...
   useEffect(() => {
     const filteredModules = modules.filter(module => module.niveau_id === 5);

     if (filteredModules.length > 9) {
       setFirstColumnModules(filteredModules.slice(0, 9));
       setSecondColumnModules(filteredModules.slice(9));
     } else {
