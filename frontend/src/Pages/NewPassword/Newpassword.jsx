        ...
        <body className='boddy'>
            <div className="form-containerr border rounded-xl overflow-hidden">
                <form className="forma" action="#">
                    ...
                    <div className="mb-2">
                        <p className="para text-gray-600 text-base">Your new password must be different from previous used password</p>
                    </div>
                    ...
                    <Link to="/home"><button id="hovering" className="here mb-6">Reset password</button></Link>
                </form>
            </div>
        </body>
     );
