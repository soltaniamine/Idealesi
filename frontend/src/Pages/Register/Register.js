            ...
            <div className={styles["form-container"] + " " + styles["sign-up-container"]}>
                <form action="#">
                    ...
                    <div className=" w-[100%] mb-5 flex justify-start items-center border-b-2 ">
                        ...
                        <input className="focus:outline-none" type="email" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)}/>  
                    </div>
                    <div className=" w-[100%] mb-12 flex justify-start items-center border-b-2 ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                        </svg>
                        <input className="focus:outline-none" type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)}/>
                    </div>
                    <button className={styles.hovering} onClick={loginUser}>Log In</button>
            ...
            <div className={styles["form-container"] + " " + styles["sign-in-container"]}>
                <form className=" " action="#">
                    ...
                    <div className=" w-[100%] mb-5 flex justify-start items-center border-b-2 ">
                        ...
                        <input className="focus:outline-none" type="text" placeholder="Full Name" value={username} onChange={(e) => setUsername(e.target.value)} />
                    </div>
                    <div className=" w-[100%] mb-5 flex justify-start items-center border-b-2 ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                    ...
                    <button className={styles.hovering} onClick={registerUser}>Sign Up</button> 
                    <div className=" mt-5 flex items-center">
                        <div className="border-b-2 w-[180px]"></div>
                        <h3 className=" mx-14 text-gray-400">or</h3>
                        <div className="border-b-2 w-[180px]"></div>
