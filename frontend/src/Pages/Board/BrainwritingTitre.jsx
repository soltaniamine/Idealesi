...
const BrainwritingTitre = ({camera,scale,id}) => {
            ...
            style={{
              transform: `translate(
                calc(${
                  ...
                  : scale < 1
                      ? (
                          scaleRound === 0.9 ? `${bounds.left-500 }px - 50%` :
                          scaleRound === 0.8 ? `${bounds.left -450}px - 50%` :
                          scaleRound == 0.7 ? `${bounds.left-400}px - 50%` :  // Assuming all conditions <= 0.7 have the same output
                          scaleRound == 0.6 ? `${bounds.left-350}px - 50%`:
                          scaleRound == 0.5 ? `${bounds.left-300}px - 50%`:
                          scaleRound == 0.4 ? `${bounds.left-250}px - 50%`:
                          scaleRound == 0.3 ? `${bounds.left-160}px - 50%`:
                          `${bounds.left-100}px - 50%`
                          
                      )
                      : (  // For scale > 1
                          scaleRound === 1.1 ? `${bounds.left-580}px - 50%` :
                          scaleRound == 1.2 ? `${bounds.left-630}px - 50%` :  // Assuming all conditions from 1.2 to 1.8 have the same output
                          scaleRound==1.3 ? `${bounds.left-680}px - 50%`:
                          `${bounds.left-750}px - 50%`
                      )
              }),
                calc(${
                    scale === 1 
                    ...
                    : scale < 1
                        ? (
                            ...
                            scaleRound == 0.6 ? `${bounds.top-45}px - 50%`:
                            scaleRound == 0.5 ? `${bounds.top-40}px - 50%`:
                            scaleRound == 0.4 ? `${bounds.top-40}px - 50%`:
                            scaleRound == 0.3 ? `${bounds.top-40}px - 50%`:
                            `${bounds.top-35}px - 50%`
...
export default BrainwritingTitre