...
const IdeasRectTitleCombin = ({camera,id,scale, insertCombin}) => {
    ...
    const id19= getId()
    const layerRaff = document.getElementById(`${id19}`)
    const boundaries = () => {
      if(layerRaff){
...
export default IdeasRectTitleCombin